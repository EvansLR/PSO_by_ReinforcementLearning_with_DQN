...
class G05:
    ...
    def constraints(self, x):
        ...
        # self.g[2] = abs(1000 * np.sin(-x[2] - 0.25) + 1000 * np.sin(-x[3] - 0.25) + 894.8 - x[0]) -(1e-4)
        # self.g[3] =abs( 1000 * np.sin(x[2] - 0.25) + 1000 * np.sin(x[2] - x[3] - 0.25) + 894.8 - x[1]) -(1e-4)
        # self.g[4] = abs(1000 * np.sin(x[3] - 0.25) + 1000 * np.sin(x[3] - x[2] - 0.25) + 1294.8) -(1e-4)
        #
